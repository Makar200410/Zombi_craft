    ...
    const pages = {
      goal: () => [
        ...
        h('ul.zc-tips',
          ...
          h('li', img(glyph('shield')), 'С самого начала ратушу охраняют 2 стражника, а лучники на её башне стреляют по нежити. Стены, вышки и казармы усиливают оборону.'),
          h('li', img(resourceIcon('food')), 'Новые жители приходят, только если есть запас еды и свободная работа. Стражники бьются мечом и щитом (щит гасит удары спереди), с «Стрельбой из лука» стреляют издали, раненые отступают к ратуше лечиться.'),
