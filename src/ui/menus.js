  ...
  _help(c, back) {
    ...
    const pages = {
      goal: () => [
        ...
        h('p', 'Постройте ', h('b', 'лабораторию'), ' и назначьте учёных: исследования открывают оружие, огнестрел, магию и укрепления.'),
        h('ul.zc-tips',
      ...
      pc: () => [keys([
        ...
        ['V', 'Вид от 1-го / 3-го лица'], ['Tab', 'Режим командования'], ['Esc / P', 'Пауза'],
      ])],
      touch: () => [keys([
        ['Джойстик слева', 'Движение'], ['Свайп справа', 'Обзор'], ['Кнопки справа', 'Атака, прыжок, действие'],
        ['Касание слота', 'Выбор предмета'], ['Кнопка «Командовать»', 'Вид сверху на деревню'], ['❚❚ вверху', 'Пауза'],
      ])],
      command: () => [
