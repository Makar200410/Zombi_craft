...
export const ZOMBIE_TYPES = {
  walker: {
    name: 'Ходячий мертвец', hp: 30, speed: 1.55, dmg: 6, cd: 1.0, reach: 0.9, blockDps: 1.1, bldDmg: 5,
    height: 1.85, width: 1, radius: 0.3, aggro: 14, knock: 3, eye: 0xff2a10, groanPitch: 1, loot: 0.45,
  },
  runner: {
    name: 'Бегун', hp: 18, speed: 3.7, dmg: 4, cd: 0.6, reach: 0.9, blockDps: 0.6, bldDmg: 3,
    height: 1.72, width: 0.9, radius: 0.28, aggro: 22, knock: 2, eye: 0xff9a18, groanPitch: 1.35, loot: 0.4,
  },
  brute: {
    name: 'Громила', hp: 150, speed: 1.2, dmg: 18, cd: 1.5, reach: 1.3, blockDps: 5.5, bldDmg: 28,
    height: 2.6, width: 1.5, radius: 0.55, aggro: 12, knock: 11, eye: 0xff1a08, groanPitch: 0.62, loot: 0.9,
  },
  spitter: {
    name: 'Плевун', hp: 26, speed: 1.9, dmg: 4, cd: 1.0, reach: 0.9, blockDps: 0.7, bldDmg: 3,
  ...
  necromancer: {
    name: 'Некромант', hp: 420, speed: 1.35, dmg: 10, cd: 1.2, reach: 1.0, blockDps: 2, bldDmg: 12,
